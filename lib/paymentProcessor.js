        ...
        function(balances, callback) {
            ...
            for (var worker in payments) {
                ...
                if (amount >= config.payments.maxAmount) {
                    transferCommands.push({
                        redis: [
                            ['hincrby', config.coin + ':workers:' + worker, 'balance', -config.payments.maxAmount],
                            ['hincrby', config.coin + ':workers:' + worker, 'paid', config.payments.maxAmount]
                        ],
                        rpc: {
                            destinations: [{
                    ...
                    transferCommands.push({
                        redis: [
                            ['hincrby', config.coin + ':workers:' + worker, 'balance', -amount],
